...
public class ProjectileGravity : Gravity
{
    ...
    //    {
    //        Vector2 gravDir = gravityPlanets[i].transform.position - this.transform.position;
    //        rb.AddForce(gravityPlanets[i].gravityMultiplier * currentGravityForce * gravDir.normalized * Time.deltaTime, ForceMode2D.Force);
    //    }
